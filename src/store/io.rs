...
pub fn write_run_record(
    ...
    task_contract_provenance: Option<crate::agent::task_contract::TaskContractProvenanceV1>,
    tool_facts: Vec<crate::agent::tool_facts::ToolFactV1>,
    tool_fact_envelopes: Vec<crate::agent::tool_facts::ToolFactEnvelopeV1>,
    run_checkpoint: Option<super::RunCheckpointV1>,
    final_checkpoint: Option<crate::agent_runtime::state::RunCheckpointV1>,
    execution_tier: Option<crate::agent_runtime::state::ExecutionTier>,
